...
public class ExeptionMessage {
    ...
    public static final String IS_EMPTY="[ERROR] 입력값이 없습니다.";
    public static final String INPUT_TYPE_ERROR="[ERROR] 숫자만 입력해 주세요.";
    public static final String NOT_DIVISIBLE_BY_THOUSAND = "[ERROR] 구입 금액이 1000원 단위가 아닙니다";
